...
StudioAreaRoomDao.prototype.getById = function(req, id, callback) {
	...
	// 	return;
	// }
	mysql.query("select * from studio_area_room where id = " + id, function (err, rows) {
		if (err) {
			callback(err);
			return;
		}
...
StudioAreaRoomDao.prototype.getListByStudioAreaIdList = function(req, idList, callback) {
	...
	mysql.query("select * from studio_area_room where studio_area_id in " + queryString, function (err, rows) {
		if (err) {
			callback(err);
			return;
		}
...
StudioAreaRoomDao.prototype.getListByIdList = function(req, idList, callback) {
	...
	mysql.query("select * from studio_area_room where id in " + queryString, function (err, rows) {
		if (err) {
			callback(err);
			return;
		}
