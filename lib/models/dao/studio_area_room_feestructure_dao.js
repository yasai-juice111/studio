...
studioAreaRoomFeestructureDao.prototype.add = function(req, params, callback) {
	...
	var queryString = 'insert into studio_area_room_feestructure (studio_area_room_feestructure_id, title, start_date, start_time, end_date, end_time, status, insert_datetime, update_datetime, delete_flag) value (?,?,?,?,?,?,?,?,?,?)';
